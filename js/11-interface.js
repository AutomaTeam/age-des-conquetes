...
const CONTROLES = [
  ...
  { key:'Glisser le fond', desc:'Déplace la caméra.' },
  { sec:'Clavier — caméra' },
  ...
  { key:'Ctrl + 1-9',  desc:'Assigne la sélection courante au groupe de contrôle correspondant.' },
  { key:'1-9',         desc:'Rappelle ce groupe de contrôle. Un second appui rapide sur le même chiffre recentre la caméra dessus.' },
